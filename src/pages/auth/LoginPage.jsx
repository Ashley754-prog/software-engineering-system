...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    try {
      ...
      console.log("Not a teacher/admin, trying student login...");
    }

    // 2. Try student login
    const studentRes = await fetch("http://localhost:3001/api/student/login", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ email: emailLower, password })
    });
    ...
    // Save student ID and go to portal
